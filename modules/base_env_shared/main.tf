...
#   private_service_cidr = var.base_private_service_cidr
 ...
 #default_region2      = var.default_region2
  ...
  subnets = [
    ...
    # {
    #   subnet_name           = "sec-${var.environment_code}-shared-base-${var.default_region2}"
    #   subnet_ip             = var.base_subnet_primary_ranges[var.default_region2]
    #   subnet_region         = var.default_region2
    #   subnet_private_access = "true"
    #   subnet_flow_logs      = true
    #   description           = "Second ${var.env} subnet."
    # },
  ]
#   secondary_ranges = {
#     "sb-${module.base_shared_vpc.network_name}-${var.default_region1}" = var.base_subnet_secondary_ranges[var.default_region1],
#    # "sb-${var.environment_code}-shared-base-${var.default_region2}" = var.base_subnet_secondary_ranges[var.default_region2]
